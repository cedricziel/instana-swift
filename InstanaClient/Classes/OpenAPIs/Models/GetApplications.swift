...
public struct GetApplications: Codable { 
    ...
    public init(pagination: Pagination?, order: Order?, timeFrame: TimeFrame?, metrics: [AppDataMetricConfiguration], nameFilter: String?, applicationId: String?, serviceId: String?, endpointId: String?, endpointTypes: [EndpointTypes]?, technologies: [String]?) {
