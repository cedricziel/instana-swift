...
open class UserAPI {
    ...
    open class func getInvitationsWithRequestBuilder() -> RequestBuilder<[UserResult]> {
        ...
        let requestBuilder: RequestBuilder<[UserResult]>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func getUsersIncludingInvitationsWithRequestBuilder() -> RequestBuilder<UsersResult> {
        ...
        let requestBuilder: RequestBuilder<UsersResult>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
