...
open class HealthAPI {
    ...
    open class func getHealthStateWithRequestBuilder() -> RequestBuilder<HealthState> {
        ...
        let requestBuilder: RequestBuilder<HealthState>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func getVersionWithRequestBuilder() -> RequestBuilder<InstanaVersionInfo> {
        ...
        let requestBuilder: RequestBuilder<InstanaVersionInfo>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
