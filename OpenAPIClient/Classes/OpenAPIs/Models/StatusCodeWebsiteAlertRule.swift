//
// StatusCodeWebsiteAlertRule.swift
//
...
public struct StatusCodeWebsiteAlertRule: Codable { 
    ...
    public init(_operator: Operator, value: StringalertType: String, metricName: String) {
